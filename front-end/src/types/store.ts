...
export interface ChatState{
  ...
  sendDirectMessage:(conversationId: string, content: string, images?: string[]) => Promise<void>
  sendGroupMessage:(conversationId: string, content: string, images?: string[]) => Promise<void>
